...
6. SEO-ПАКЕТ ДЛЯ САЙТА
Все тексты уникальны между собой: не повторяй одну и ту же фразу в двух полях.
...
- short_description — одно предложение до 200 символов для плитки каталога:
  что это и главное преимущество.
- seo_description — 350–600 символов, 3–5 предложений: что это → ключевые
  параметры цифрами → кому и для чего подходит. Только факты из данных.

...
const CODE_TO_SPEC = {
  ...
  washer_type: 'вид_стиральной_машины',
  install: 'установка',
  ...
  climate_class: 'климатический_класс',
  compressors: 'количество_компрессоров',
...
const DICT_FALLBACK = {
  ...
  953: 467, // «Полуавтоматические стиральные машины» → справочник стиральных
};

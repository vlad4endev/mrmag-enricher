...
/** Кириллица, которую магазины путают с латиницей в артикулах (60С1010 / 60C1010). */
const LOOKALIKE = {
  а: 'a', е: 'e', о: 'o', р: 'p', с: 'c', у: 'y', х: 'x',
  к: 'k', м: 'm', т: 't', н: 'h', в: 'b',
};

export function foldLookalikes(s) {
  return fold(s).replace(/[аеорсухквтнм]/g, ch => LOOKALIKE[ch] || ch);
}
